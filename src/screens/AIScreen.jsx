...
// import { generateAIWord, clearAIResponse } from '../store/slices/aiSlice';
...
export default function AIScreen() {
  ...
  //   // dispatch(generateAIWord(payload));
...
const generatePayload = useCallback(() => {
    ...
    dispatch(generateAIWord(payload)); // Dispatch the thunk directly
    return payload;
  }, [currentWord, nativeLangCode, dispatch]);
